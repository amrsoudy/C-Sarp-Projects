...
namespace MyWCFService
{
    ...
    {
        [OperationContract]
        string Verifier(int value, string MachineName, String MachineIP, String UserName, DateTime date);
        void SauvgarderBDD(int value, string MachineName, String MachineIP, String UserName, DateTime date);
