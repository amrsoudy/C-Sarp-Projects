...
namespace WCFClient.ServiceReference1 {
    ...
    public interface IService1 {
        ...
        string Verifier(int value, string MachineName, string MachineIP, string UserName, System.DateTime date);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/Verifier", ReplyAction="http://tempuri.org/IService1/VerifierResponse")]
        System.Threading.Tasks.Task<string> VerifierAsync(int value, string MachineName, string MachineIP, string UserName, System.DateTime date);
    }
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<WCFClient.ServiceReference1.IService1>, WCFClient.ServiceReference1.IService1 {
        ...
        public string Verifier(int value, string MachineName, string MachineIP, string UserName, System.DateTime date) {
            return base.Channel.Verifier(value, MachineName, MachineIP, UserName, date);
        }
        
        public System.Threading.Tasks.Task<string> VerifierAsync(int value, string MachineName, string MachineIP, string UserName, System.DateTime date) {
